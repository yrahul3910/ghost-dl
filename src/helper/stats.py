...
p("--higher", default=False, metavar="N",
  help="setting whether the number is higher the better")
p("--deltaV", default=0.147, metavar="N",
  help="default is 0.147 and used for changing small effect threshold")
...
The.higherBetter = args.higher
The.useA12 = args.useA12
The.deltaV = args.deltaV
